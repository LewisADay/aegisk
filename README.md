...
Please note a large proportion of this repository is imported from AEGiS found at https://github.com/georgedeath/aegis. Notably this readme is largely simply an adapted form of the readme from that repository to make the appropriate changes for this work.
